...
var (
	cliPort = kingpin.Flag("port", "Port for Prometheus to scrape metrics").Default(":9000").OverrideDefaultFromEnvar("METRICS_PORT").String()
	cliPath = kingpin.Flag("path", "Path for Prometheus to scrape metrics").Default("/metrics").OverrideDefaultFromEnvar("METRICS_PATH").String()
